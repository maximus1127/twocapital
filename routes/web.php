...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function () {
    ...
    //media
    Route::get('/add-media', 'MediaController@create')->name('add-media');
    Route::post('/add-media', 'MediaController@store');
    Route::get('/delete-media/{media}', 'MediaController@destroy')->name('delete-media');
});
...
Route::view('/madelinecove', 'spa-views.salt2020')->name('salt2020');
Route::view('/terms-of-service', 'spa-views.tos');
Route::view('/privacy-policy', 'spa-views.privacy');
Route::get('/media', 'MediaController@spaMedia')->name('spa-media');
Route::view('/learn-about-membership', 'spa-views.membership');
